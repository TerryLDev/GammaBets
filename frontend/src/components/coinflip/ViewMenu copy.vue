  ...
  computed: {
    timerText() {
      if (this.game.playerTwoJoining == false) {
        ...
        this.game.playerTwoJoining &&
        this.game.playerTwoJoined == false
      ) {
    ...
    playerOneTotalVal() {
      return this.$store.getters
        .getPlayerOneTotalValue(this.game.gameID)
        .toFixed(2);
    },
    playerTwoTotalVal() {
      return this.$store.getters
        .getPlayerTwoTotalValue(this.game.gameID)
        .toFixed(2);
    },
  },
  name: "ViewMenu",
