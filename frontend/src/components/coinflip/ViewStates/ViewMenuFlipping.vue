				...
				<div class="val-items-container-view">
					<div class="val-container-view">
						<p>
							${{
								playerTotalVal(
									game.game.playerOne.skins.skinValues
								)
							}}
						</p>
					</div>
				...
				<div style="align-self: end" class="val-items-container-view">
					...
					<div class="val-container-view">
						<p>
							${{
								playerTotalVal(
									game.game.playerTwo.skins.skinValues
								)
							}}
						</p>
					</div>
		...
		<div class="bottom-view">
			...
			>
				...
				>
					...
					<p>
						${{
							getSkinValue(game.game.playerOne.skinValues[index])
						}}
					</p>
				</div>
			</div>
			...
			>
				...
				>
					...
					<p>
						${{
							getSkinValue(game.game.playerTwo.skinValues[index])
						}}
					</p>
				</div>
			</div>
